  ...
  _$CityDao(this.database, this.changeListener)
      : _queryAdapter = QueryAdapter(database),
        _cityInsertionAdapter = InsertionAdapter(database, 'City',
                (CityEntity item) => <String, Object?>{'id': item.id, 'name': item.cityName});
